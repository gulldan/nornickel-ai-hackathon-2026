// Package amqp is office-parser's delivery layer. It decodes the protobuf AMQP
// body into a DocumentUploaded event and hands it to the application processor.
// The returned function satisfies platform/messaging.HandlerFunc.
package amqp
